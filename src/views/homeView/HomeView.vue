    ...
    <div class="container">
      ...
      <div class="home__view-div" v-else>
        <div class="home__view-div-top">
          ...
          <vue-awesome-paginate class="home__view-pagination-none" :total-items="+productsStore.total"
            v-model="currentPage" :items-per-page="20" :max-pages-shown="5" paginate-buttons-class="btn"
