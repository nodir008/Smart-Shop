...
<template>
    <div class="order-div">
        <div class="orders">
            <div class="container">
                <h1 class="orders-title" v-if="orderStore.orders.length > 0">Yetkazib berilayotgan mahsulotlar</h1>
                <div class="drawer">
                                ...
                                <div class="drawer__card-card">
                                    ...
                                    <div class="drawer__card-div">
                                        ...
                                        <div class="drawer__card-time">
                                            <p class="drawer__card-time-text">Yetkazib berish kutilmoqda:</p>
                    ...
                    <div class="order__price" v-if="orderStore.orders.length > 0">
                        ...
                        <p class="order__price-text">Yetkazilayabdi</p>
